...
(function(Y) {
    ...
    function ea(b) {
        ...
        function C() {
            var a, f, b, e, n = (b = 1E3 * m.waitSeconds) &&
                k.startTime + b < (new Date).getTime(),
                c = [],
                h = [],
                g = !1,
                l = !0;
    ...
    var L = w.toString,
        ...
        z = !!("undefined" !== typeof window && navigator &&
            document),
    ...
    if ("undefined" === typeof define) {
        ...
        z && M(document.getElementsByTagName("script"), function(b) {
            B || (B = b.parentNode);
            if (s = b.getAttribute("data-main")) return q.baseUrl || (H = s.split("/"), ba = H.pop(), ca = H.length ? H.join("/") + "/" : "./", q.baseUrl = ca, s = ba), s = s.replace(aa, ""), q.deps = q.deps ? q.deps.concat(s) : [s], !0
        });
